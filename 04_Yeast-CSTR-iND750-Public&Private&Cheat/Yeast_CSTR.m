...
VGmax = 63.45;     % maximum glucose uptake rate (mmol/gDW/h)
KmG = 61.67;      % glucose uptake saturation constants (mmol/L)
VFmax = 63.45;     % maximum fructose uptake rate (mmol/gDW/h)
KmF = 61.67;      % fructose uptake saturation constants (mmol/L)
VSmax = 5.77;     % maximum sucrose uptake rate (mmol/gDW/h)
KmS = 26.56;      % sucrose uptake saturation constants (mmol/L)
