function Yeast_MP_sucrose_function(scrini,pbini,prini,chini,data_index)
...
load iND750 iND750
load iND750_Private iND750_Private
load iND750_Cheat iND750_Cheat
...
%% Save value
eval(['T',num2str(data_index),'=','T;']);
eval(['Y',num2str(data_index),'=','Y;']);
eval(['flux',num2str(data_index),'=','flux;']);
eval(['save data',num2str(data_index),' T',...
    num2str(data_index),' Y',num2str(data_index),' flux',num2str(data_index)]);
end
