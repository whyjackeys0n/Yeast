...
ylabel('L-Leucine (mmol/L)');
set(gca,'FontSize',FS);

subplot(2,3,6)
plot(T1,Y1(:,11),'linewidth',2.5);
hold on
plot(T2,Y2(:,11),'linewidth',2.5);
ylabel('L-Histidine (mmol/L)');
set(gca,'FontSize',FS);
...
subplot(2,3,5)
plot(T1,flux1(:,15),'linewidth',2.5);
hold on
plot(T2,flux2(:,15),'linewidth',2.5);
ylabel('L-Leucine (mmol/g/h)');
set(gca,'FontSize',FS);

subplot(2,3,6)
plot(T1,flux1(:,16),'linewidth',2.5);
hold on
plot(T2,flux2(:,16),'linewidth',2.5);
ylabel('L-Histidine (mmol/g/h)');
set(gca,'FontSize',FS);