...
dL   = D*(-L)   + pb_vleu*Xpb + pr_vleu*Xpr + ch_vleu*Xch;
dH   = D*(-H)   + pb_vhis*Xpb + pr_vhis*Xpr + ch_vhis*Xch;

fluxy = [fluxy, pb_mu, pb_vglc, pb_vfru, pb_vscr, pb_veth, pb_voxy, pb_vleu, pb_vhis...
              , pr_mu, pr_vglc, pr_vfru, pr_vscr, pr_veth, pr_voxy, pr_vleu, pr_vhis...
              , ch_mu, ch_vglc, ch_vfru, ch_vscr, ch_veth, ch_voxy, ch_vleu, ch_vhis];

dy = [dy dXpb dXpr dXch dG dF dS dE dOg dOl dL dH];
