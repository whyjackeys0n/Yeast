...
dG   = D*(Gf-G) + pb_vglc*Xpb + pr_vglc*Xpr + ch_vglc*Xch;
dF   = D*(Ff-F) + pb_vfru*Xpb + pr_vfru*Xpr + ch_vfru*Xch;
dS   = D*(Sf-S) + pb_vscr*Xpb + pr_vscr*Xpr + ch_vscr*Xch;
...
dPh   = D*(-Ph)   + pb_vpho*Xpb + pr_vpho*Xpr + ch_vpho*Xch;
dSu   = D*(-Su)   + pb_vsul*Xpb + pr_vsul*Xpr + ch_vsul*Xch;

fluxy = [fluxy, pb_mu, pb_vglc, pb_vfru, pb_vscr, pb_veth, pb_voxy, pb_vpho, pb_vsul...
              , pr_mu, pr_vglc, pr_vfru, pr_vscr, pr_veth, pr_voxy, pr_vpho, pr_vsul...
              , ch_mu, ch_vglc, ch_vfru, ch_vscr, ch_veth, ch_voxy, ch_vpho, ch_vsul];

dy = [dy dXpb dXpr dXch dG dF dS dE dOg dOl dPh dSu];
