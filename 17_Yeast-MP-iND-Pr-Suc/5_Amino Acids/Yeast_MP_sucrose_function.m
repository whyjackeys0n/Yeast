...
VmaxLeu = 5;           % maximum leucine uptake rate (mmol/gDW/h)
KmLeu = 1;              % leucine uptake saturation constants (mmol/L)
VmaxHis = 5;           % maximum histidine uptake rate (mmol/gDW/h)
KmHis = 1;              % histidine uptake saturation constants (mmol/L)
param = [VmaxG; KmG; VmaxF; KmF; VmaxS; KmS; VmaxO; KmO; VmaxLeu; KmLeu; VmaxHis; KmHis];
