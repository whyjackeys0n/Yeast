...
[DFBA_time_1,DFBA_biomass_private_1] = Yeast_MP_sucrose_function(1,1);
[DFBA_time_2,DFBA_biomass_private_2] = Yeast_MP_sucrose_function(4,2);

%% Plot
figure(1)
h1 = plot(DFBA_time_1,DFBA_biomass_private_1,'-k','linewidth',2.5);
hold on
h2 = plot(DFBA_time_2,DFBA_biomass_private_2,'-k','linewidth',2.5);
set(gca,'fontsize',24);
