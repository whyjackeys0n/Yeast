...
iAmm = find(strcmp(iND750.rxnNames,'Ammonia exchange'));
...
VGmax = 1;              % maximum glucose uptake rate (mmol/gDW/h)
KmG = 1;                % glucose uptake saturation constants (mmol/L)
VFmax = 1;              % maximum fructose uptake rate (mmol/gDW/h)
KmF = 1;                % fructose uptake saturation constants (mmol/L)
VSmax = 15;             % maximum sucrose uptake rate (mmol/gDW/h)
KmS = 5;                % sucrose uptake saturation constants (mmol/L)
VOmax = 4;              % maximum oxygen uptake rate (mmol/gDW/h)
KmO = 0.1/32;           % oxygen uptake saturation constants (mmol/L)
VAmax = 5;              % maximum ammonia uptake rate (mmol/gDW/h)
KmA = 1;                % ammonia uptake saturation constants (mmol/L)
param = [VGmax; KmG; VFmax; KmF; VSmax; KmS; VOmax; KmO; VAmax; KmA];
...
yz = [Xpbi, Xpri, Xchi, Gi, Fi, Si, Ei, Ogi, Oli, Ai];
