...
dA   = D*(-A)    + pb_vamm*Xpb + pr_vamm*Xpr + ch_vamm*Xch;

fluxy = [fluxy, pb_mu, pb_vglc, pb_vfru, pb_vscr, pb_veth, pb_voxy, pb_vamm...
              , pr_mu, pr_vglc, pr_vfru, pr_vscr, pr_veth, pr_voxy, pr_vamm...
              , ch_mu, ch_vglc, ch_vfru, ch_vscr, ch_veth, ch_voxy, ch_vamm];

dy = [dy dXpb dXpr dXch dG dF dS dE dOg dOl dA];
