function [dy,fluxy]= DRHS_engineeredCauto(t, y, INFO)
...
dBUT = er_but(i)*Xer + ca_but(i)*Xca - D*BUT;

fluxy = [fluxy ca_mu(i) ca_c(i) ca_c2(i) ca_a(i) ca_e(i) ca_bdo(i) ca_lac(i) ca_h(i) ca_but(i) er_mu(i) er_g(i) er_c2(i) er_but(i) er_a(i) er_lac(i) er_h(i)];
