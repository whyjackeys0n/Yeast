...
figure(1)
subplot(2,4,1)
plot(T1,Y1(:,1),'linewidth',2.5);
hold on
plot(T2,Y2(:,1),'linewidth',2.5);
ylabel('Biomass (g/L)');
set(gca,'FontSize',FS)
...
figure(2)
subplot(2,3,1)
plot(T1,flux1(:,1),'linewidth',2.5);
hold on
plot(T2,flux2(:,1),'linewidth',2.5);
ylabel('Growth (h-1)');
set(gca,'FontSize',FS)

subplot(2,3,2)
plot(T1,flux1(:,4),'linewidth',2.5);
hold on
plot(T2,flux2(:,4),'linewidth',2.5);
ylabel('Sucrose (mmol/g/h)');
set(gca,'FontSize',FS)

subplot(2,3,3)
plot(T1,flux1(:,2),'linewidth',2.5);
hold on
plot(T2,flux2(:,2),'linewidth',2.5);
ylabel('Glucose (mmol/g/h)');
set(gca,'FontSize',FS)

subplot(2,3,4)
plot(T1,flux1(:,3),'linewidth',2.5);
hold on
plot(T2,flux2(:,3),'linewidth',2.5);
ylabel('Fructose (mmol/g/h)');
set(gca,'FontSize',FS)

subplot(2,3,5)
plot(T1,flux1(:,5),'linewidth',2.5);
hold on
plot(T2,flux2(:,5),'linewidth',2.5);
ylabel('Ethanol (mmol/g/h)');
set(gca,'FontSize',FS)

subplot(2,3,6)
plot(T1,flux1(:,6),'linewidth',2.5);
hold on
plot(T2,flux2(:,6),'linewidth',2.5);
