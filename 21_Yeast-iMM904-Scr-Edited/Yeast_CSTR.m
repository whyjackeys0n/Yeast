...
load iMM904
modelpb = iMM904;   % modelwt: model_wild_type

iGr  = find(strcmp(modelpb.rxnNames, 'Biomass SC5 notrace'));
...
iATP = find(strcmp(modelpb.rxnNames, 'ATP maintenance requirement'));
